...
* [Ubuntu with Apache ](/docs/installation/providers/enterprise/ubuntu-apache) <span class="label" style="background-color: #339933; color: Black; border-radius:6px; padding:4px"> Recommended
    </span>
