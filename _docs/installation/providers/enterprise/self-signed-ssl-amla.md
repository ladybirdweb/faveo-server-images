...
layout: single
type: docs
permalink: /docs/installation/providers/enterprise/self-signed-ssl-amla/
redirect_from:
  - /theme-setup/
...
## Introduction
This document will guide on how to install Self-Signed SSL certificates on Amla Linux 9 with apahce.
